...
public class LessonTest
{
    ...
    {
	Lesson l1 = new Lesson(JSON_OBJECT);
	assertEquals("Lesson [curso=" + l1.getCurso() + ", unidadeCurricular=" + l1.getUnidadeCurricular() + ", turno="
		+ l1.getTurno() + ", turma=" + l1.getTurma() + ", inscritosNoTurno=" + l1.getInscritosNoTurno()
		+ ", diaDaSemana=" + l1.getDiaDaSemana() + ", horaInicio=" + l1.getHoraInicio() + ", horaFim="
		+ l1.getHoraFim() + ", data=" + l1.getData() + ", sala=" + l1.getSala() + ", lotacao=" + l1.getLotacao()
		+ "]", l1.toString());
    }
}
